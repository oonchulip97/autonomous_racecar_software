/*
* Refer to http://wiki.ros.org/razor_imu_9dof for more information.
*/
...
float ACCEL_X_MAX = 244;
float ACCEL_Y_MIN = -264;
float ACCEL_Y_MAX = 247;
float ACCEL_Z_MIN = -254;
...
float magn_ellipsoid_center[3] = {-65.0016, 181.428, -52.8959};
float magn_ellipsoid_transform[3][3] = {{0.368256, -0.00443682, -0.0152621}, {-0.00443682, 0.340406, 0.0459800}, {-0.0152621, 0.0459800, 0.996411}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = 63.46;
float GYRO_AVERAGE_OFFSET_Y = 82.90;
float GYRO_AVERAGE_OFFSET_Z = -1.02;
